...
<head>
    ...
    <link rel="stylesheet" href="border collie.css">
...
<body>
    ...
    <section class="profile-header">
        <div class="cover-photo">
            <img src="blakecapa.jpg" alt="Capa" />
        </div>
        
        <div class="profile-info">
            <div class="profile-pic">
                <img src="blake.jpg" alt="Foto de Perfil" />
            </div>
            
            <div class="user-info">
                <h1 id="username">Border Collie</h1>
    ...
    <script src="perfilblake.js"></script>
</body>
</html>
